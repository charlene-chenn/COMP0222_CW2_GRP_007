...
parser = argparse.ArgumentParser(description="Visualize replayed Lidar data.")
parser.add_argument('--file', type=str, default='outdoor_lidar3_scan_data.json', help='The JSON file to replay (e.g. lab_data_01.json)')
args = parser.parse_args()

# 1. Setup the driver in Replay mode
driver = LidarDriver(mode='replay', filename=args.file)
