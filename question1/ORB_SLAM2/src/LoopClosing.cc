...
bool LoopClosing::DetectLoop() {
  ...
  // *************************LOOP CLOSURE DISABLED IMPLEMENTATION**************************
  // Loop closure disabled: register the KF in the database so relocalisation
  // still works, then short-circuit before any candidate detection.
