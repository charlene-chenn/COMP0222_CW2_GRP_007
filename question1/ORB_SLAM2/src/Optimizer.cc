...
int Optimizer::PoseOptimization(Frame *pFrame) {
  ...
  // Outlier rejection disabled: thresholds raised so no observation is ever
  // flagged as an outlier in the per-frame motion-only optimisation.
  ...
  const float chi2Stereo[4] = {1e10, 1e10, 1e10, 1e10};
  // *********************EDITED PARAMETERS*****************************
